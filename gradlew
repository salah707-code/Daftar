...
if [ "$cygwin" = "false" -a "$darwin" = "false" -a "$nonstop" = "false" ] ; then
    case $MAX_FD in
      max*)
        ...
        # Setting the hard limit requires root privileges, so we check if that was successful.
...
# If wrapper jar is not present, fall back to global gradle or download wrapper
if [ ! -f "$CLASSPATH" ]; then
